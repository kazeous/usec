...
export function TournamentOperations({ tournament, entries, teams, solos }: {
  tournament: { id: string; title: string; game: Game; format: TournamentFormat; status: TournamentStatus; registrationOpen: boolean; registrationMessage?: string | null; venue?: string | null; locationMode: LocationMode; participationFormat: ParticipationFormat; registrationClosesAt?: string | null; startsAt?: string | null; swissRounds?: number | null; currentRound: number };
  entries: Entry[];
  teams: Team[];
  solos: Solo[];
}) {
